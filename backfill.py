...
VIEW_ID = '244658557'  # Your Google Analytics View ID
BIGQUERY_PROJECT = 'deserved-analytics-dev'  # Your Google Cloud Project ID
BIGQUERY_DATASET = 'ua_pleskop_backfill'  # BigQuery Dataset name where the data will be stored
BIGQUERY_TABLE = 'test_backfill'  # BigQuery Table name where the data will be stored, if it does not exist, it will be created
